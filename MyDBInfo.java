...
public class MyDBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108lblake";
	public static final String MYSQL_PASSWORD = "3nSZ3hf7vbktHKqv";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_lblake";
