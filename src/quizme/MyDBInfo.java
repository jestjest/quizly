...
public class MyDBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108jestinm";
	public static final String MYSQL_PASSWORD = "2pV832WXmzr9FnxN";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_jestinm";
}
